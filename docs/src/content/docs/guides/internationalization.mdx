...
Mainly the demo app supports two languages: English and Arabic (RTL). You can add more languages by adding the translation files in the `src/translations` folder and adding the language code to the `src/translations/i18n/resources.ts` file.

<CodeBlock file="src/translations/i18n/resources.ts" />
...
<CodeBlock file="src/translations/i18n/utils.tsx" />
